  			...
  			<div class="modal-dialog" role="document">
    			<div class="modal-content">
      				...
      				<div class="modal-body">
        				...
        				<ul>
        					<h4>The information of Single Singer:</h4>
        					<p>Put pictures for slide show to here</p>
        					<p>Put picture of Single singer</p>
        					<li>Name<br><input placeholder="Name"></input></li>
        					<li>Surname<br><input placeholder="Surname"></input></li>
        					<li>Biography of single singer:<br><input placeholder="Biography"></input></li>
        					<li>Album<br><p>Put album's picture here</p></li>
        					<li><p>Put songs here</p></li>
        				</ul>
        			</div>
      				<div class="modal-footer">
        				<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
