...
<body>
	...
	<div class="container">
		...
		<!-- Indicators -->
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
			    	<img src="../Img/Beatles.jpg" alt="image">
			    	<div class="carousel-caption">
			        	...
			    	</div>
				</div>
				<div class="item">
			    	<img src="../Img/Beatles1.jpg" alt="image">
			    	<div class="carousel-caption">
			        	...
			    	</div>
				</div>
				<div class="item">
			    	<img src="../Img/Beatles2.jpg" alt="image">
			    	<div class="carousel-caption">
			        	...
			    	</div>
				</div>
		...
		<div class="row">
			...
			<div class="col-md-9">
				<div class="well">
					<img src="../Img/Betconcert.jpg" class="img-responsive img-rounded">
				</div>
			</div>
			<div class="col-md-3">
				<div class="well">
					<p>John Lennon</p>
					<img src="../Img/JN.jpg" class="img-responsive img-rounded">
				</div>
			</div>
			<div class="col-md-9">
				<div class="well">
		...
		<div class="row">
			<div class="col-md-3">
				<div class="well">
					<p>Paul Mccartney</p>
					<img src="../Img/PM.jpg" class="img-responsive img-rounded">
				</div>
			</div>
			<div class="col-md-9">
				<div class="well">
		...
		<div class="row">
			<div class="col-md-3">
				<div class="well">
					<p>Ringo Starr</p>
					<img src="../Img/RS.jpg" class="img img-responsive">
				</div>
			</div>
			<div class="col-md-9">
				<div class="well">
		...
		<div class="row">
			<div class="col-md-3">
				<div class="well">
					<p>George Harrison</p>
					<img src="../Img/GH.jpg" class="img img-responsive">
				</div>
			</div>
			<div class="col-md-9">
				<div class="well">
